...
var whitelisttwo = ['pants','shoes','gloves','helmet','coat','blade','staff','wshield']; //Add items that you want to be upgraded as they come to your inventory [always add ' ' around item and , after item]
...
function upgrade(level) {
  for (let i = 0; i < character.items.length; i++) {
    ...
    if (c && whitelisttwo.includes(c.name) && c.level < level) {
